...
namespace AGVproject.Class
{
    ...
    class AST_GuideBySurrounding
    {
        ...
        public static int getSpeedA_KeepL_Forward()
        {
            ...
            // 控制策略
            double current = getFitAngle(points, 0, HouseStack.DefaultAisleWidthUD / 2 - Hardware_PlatForm.AxisSideL);
            double target = 0;
            double Kp = 30;
            double adjust = Kp * (current - target);
        ...
        public static int getSpeedA_KeepR_Forward()
        {
            ...
            // 控制策略
            double current = getFitAngle(points, 0, HouseStack.DefaultAisleWidthUD / 2 + Hardware_PlatForm.AxisSideR);
            double target = 0;
            double Kp = 30;
        ...
        public static int getSpeedA_KeepR_Backward()
        {
            ...
            // 控制策略
            double current = getFitAngle(points, -Hardware_PlatForm.AxisSideD, HouseStack.DefaultAisleWidthUD / 2 + Hardware_PlatForm.AxisSideR);
            double target = 0;
            double Kp = 20;
